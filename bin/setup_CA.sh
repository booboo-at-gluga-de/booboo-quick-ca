...
CUSTOMER_CERT_DIR=\$BOOBOO_QUICK_CA_BASE/customer_certs
CUSTOMER_CERT_CERT_FILE_PEM=\$CUSTOMER_CERT_DIR/\${CUSTOMER_CERT_CN}.\${CUSTOMER_CERT_DATE_EXTENSION}.cert.pem
CUSTOMER_CERT_CERT_FILE_DER=\$CUSTOMER_CERT_DIR/\${CUSTOMER_CERT_CN}.\${CUSTOMER_CERT_DATE_EXTENSION}.cert.der
CUSTOMER_CERT_CSR_FILE=\$BOOBOO_QUICK_CA_BASE/csr/\${CUSTOMER_CERT_CN}.\${CUSTOMER_CERT_DATE_EXTENSION}.csr
CUSTOMER_CERT_PKCS12_FILE=\$CUSTOMER_CERT_DIR/\${CUSTOMER_CERT_CN}.\${CUSTOMER_CERT_DATE_EXTENSION}.p12
CUSTOMER_CERT_JKS_FILE=\$CUSTOMER_CERT_DIR/\${CUSTOMER_CERT_CN}.\${CUSTOMER_CERT_DATE_EXTENSION}.jks
END
